...
OutDir = /work/jelber2/immunome_2014/combined/call-SNPs-recal01
Output Files = Sample-recal01.bam


Usage (execute following code in InDir):

find . -name '*-realigned.bam' -not -name 'ALL-samples-*' -exec ~/scripts/immunome_2014/07-qual_score_recal01.py {} \;
...
if len(sys.argv)<2:
    ...
    for InFileName in FileList: # do the following steps for each file in the inputstream
        ...
        WallTime = "02:00:00"
        LogOut = "/work/jelber2/immunome_2014/combined/call-SNPs-recal01"
        LogMerge = "oe"
