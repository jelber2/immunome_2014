...
Command:
cd InDir = /work/jelber2/immunome_2014/run2/stampy-alignment
...
(1)/work/jelber2/immunome_2014/run2/stampy-alignment
(2)                                /clean-sort-addRG

InDir = /work/jelber2/immunome_2014/run2/stampy-alignment
...
if len(sys.argv)<2:
    ...
    for InFileName in FileList: # so samtools grabs only the file names (i.e., Samples)
        ...
        WallTime = "00:30:00"
        LogOut = "/work/jelber2/immunome_2014/run2/clean-sort-addRG"
        LogMerge = "oe"
