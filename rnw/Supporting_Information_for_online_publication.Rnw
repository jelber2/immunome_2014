...
inferred by microsatellites. Molecular Ecology.}
\date{}
\author{}
...
\endfirsthead
\multicolumn{1}{l}
{Table S1 -- \textit{Continued from previous page}} \\
\hline
\textbf{Gene}\\
\hline
\endhead
...
\pagebreak{}
\noindent
\includegraphics [scale=1.0]{snp_structure_k2}
\noindent
...
\pagebreak{}
\noindent
\includegraphics [scale=1.0]{msat_structure_k3}
\noindent
